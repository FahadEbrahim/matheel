...
@click.option(
    ...
    default='auto',
    show_default=True,
    help='Vector backend. Auto routes to dense, static, or Sentence Transformers multi-vector models.',
)
@click.option(
    '--similarity-function',
...
@click.option(
    ...
    default='mean',
    show_default=True,
    help='Sentence-transformers pooling mode. Ignored by model2vec and multivector models.',
)
@click.option(
    '--device',
    type=click.Choice(("auto",) + available_runtime_devices()),
