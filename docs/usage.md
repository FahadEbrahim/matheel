...
| Extra | Use it for |
| --- | --- |
| `matheel[semantic]` | Sentence Transformers (including multivector) and Model2Vec semantic scoring backends. |
...
Compatibility extras remain available for narrower installs: `sentence_transformers`, `model2vec`, and `chunking_code`.
